                ...
                <div className="">
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`rounded px-2 w-28 text-sm py-3 mt-2 hover:bg-blue-700 text-white  ${isSubmitting ? 'cursor-not-allowed bg-blue-900' : ' bg-blue-600 cursor-pointer'} disabled:bg-blue-900`}
                      type="submit"
                    >
                      Send Email
                    </button>
