          ...
          <div className="md:w-1/2 w-full md:h-full relative">
            ...
            <div className="rounded-lg absolute top-0 left-0 backdrop-blur-[200px] h-full w-full text-white">
              <div className="w-2/3 mx-auto mt-28">
                <h4 className="font-bold text-3xl uppercase">Reset Password</h4>
                <div className="">
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`rounded px-2 w-24 py-2 disabled:bg-blue-900  mt-5 hover:bg-blue-700 text-white  ${isSubmitting ? 'cursor-not-allowed ' : ' bg-blue-600 cursor-pointer'} `}
                      type="submit"
                    >
                      Update
                    </button>
